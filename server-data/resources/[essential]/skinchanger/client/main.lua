local Components = {
  ...
  {label = _U('watches_1'),             name = 'watches_1',     value = 0,  min = 0,  zoomOffset = 0.6,   camOffset = 0.65}, --
  ...
  {label = _U('bproof_1'),            	name = 'bproof_1',      value = 0,  min = 0,  zoomOffset = 0.6,   camOffset = 0.65}, --
  {label = _U('bproof_2'),              name = 'bproof_2',      value = 0,  min = 0,  zoomOffset = 0.6,   camOffset = 0.65, textureof = 'bproof_1'},
...
function ApplySkin(skin, clothes)
  ...
  SetPedHeadBlendData    (playerPed, Character['dad'], Character['mom'], nil, Character['skin'], Character['skin'], Character['skin'], Character['face'] * 0.1, Character['face'] * 0.1, nil, true)
  ...
  if Character['watches_1'] == -1 then
    ...
    SetPedPropIndex(playerPed, 6, Character['watches_1'], Character['watches_2'], 2)  -- Ears Accessories
  end
...
function ApplyClothesWardrobe(skin, clothes)
...
function ApplyDoplnekBryle(skin, clothes)
...
function ApplyDoplnekHodinky(skin, clothes)
...
function ApplyDoplnekMasky(skin, clothes)
...
function ApplyDoplnekUsi(skin, clothes)
...
function ApplyDoplnekCepice(skin, clothes)
...
function ApplyDoplnekNaramek(skin, clothes)
...
function ApplyDoplnekTaska(skin, clothes)
...
function ApplyDoplnekKrk(skin, clothes)
...
RegisterNetEvent('skinchanger:loadClothesWardrobe')
AddEventHandler('skinchanger:loadClothesWardrobe', function(playerSkin, clothesSkin)
  ...
  if playerSkin['sex'] ~= LastSex then
    ...
    ApplyClothesWardrobe(playerSkin, clothesSkin)
  end
...
RegisterNetEvent('skinchanger:loadDoplnekBryle')
AddEventHandler('skinchanger:loadDoplnekBryle', function(playerSkin, clothesSkin)
  ...
  if playerSkin['sex'] ~= LastSex then
    ...
    ApplyDoplnekBryle(playerSkin, clothesSkin)
  end
...
RegisterNetEvent('skinchanger:loadDoplnekHodinky')
AddEventHandler('skinchanger:loadDoplnekHodinky', function(playerSkin, clothesSkin)
  ...
  if playerSkin['sex'] ~= LastSex then
    ...
    ApplyDoplnekHodinky(playerSkin, clothesSkin)
  end
...
RegisterNetEvent('skinchanger:loadDoplnekMasky')
AddEventHandler('skinchanger:loadDoplnekMasky', function(playerSkin, clothesSkin)
  ...
  if playerSkin['sex'] ~= LastSex then
    ...
    ApplyDoplnekMasky(playerSkin, clothesSkin)
  end
...
RegisterNetEvent('skinchanger:loadDoplnekUsi')
AddEventHandler('skinchanger:loadDoplnekUsi', function(playerSkin, clothesSkin)
  ...
  if playerSkin['sex'] ~= LastSex then
    ...
    ApplyDoplnekUsi(playerSkin, clothesSkin)
  end
...
RegisterNetEvent('skinchanger:loadDoplnekCepice')
AddEventHandler('skinchanger:loadDoplnekCepice', function(playerSkin, clothesSkin)
  ...
  if playerSkin['sex'] ~= LastSex then
    ...
    ApplyDoplnekCepice(playerSkin, clothesSkin)
  end
...
RegisterNetEvent('skinchanger:loadDoplnekNaramek')
AddEventHandler('skinchanger:loadDoplnekNaramek', function(playerSkin, clothesSkin)
  ...
  if playerSkin['sex'] ~= LastSex then
    ...
    ApplyDoplnekNaramek(playerSkin, clothesSkin)
  end
...
RegisterNetEvent('skinchanger:loadDoplnekTaska')
AddEventHandler('skinchanger:loadDoplnekTaska', function(playerSkin, clothesSkin)
  ...
  if playerSkin['sex'] ~= LastSex then
    ...
    ApplyDoplnekTaska(playerSkin, clothesSkin)
  end
...
RegisterNetEvent('skinchanger:loadDoplnekKrk')
AddEventHandler('skinchanger:loadDoplnekKrk', function(playerSkin, clothesSkin)
  ...
  if playerSkin['sex'] ~= LastSex then
    ...
    ApplyDoplnekKrk(playerSkin, clothesSkin)
  end
