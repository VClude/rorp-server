...
RegisterServerEvent('rtx_core:registerPeriodCron')
AddEventHandler('rtx_core:registerPeriodCron', function(cron, time)
    if cron == nil then
        cron = function()
...
RegisterServerEvent('rtx_core:registerTimeCron')
AddEventHandler('rtx_core:registerTimeCron', function(cron, time)
    local job = {}
