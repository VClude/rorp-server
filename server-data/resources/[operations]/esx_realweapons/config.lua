...
Config.RealWeapons = {
	...
	{name = 'WEAPON_BAT', 				bone = 58271, x = -0.01, y = 0.0,  z = -0.07, xRot = -240.0,  yRot = 65.0, zRot = 0.0, category = 'melee', 		model = 'w_me_bat'},
	...
	{name = 'WEAPON_PISTOL', 			bone = 24818, x = -0.01, y = -0.15, z = 0.1, xRot = 10.0, yRot = 240.0, zRot = 10.0, category = 'handguns', 	model = 'w_pi_pistol'},
