...
Config.RealWeapons = {
	...
	{name = 'WEAPON_BAT', 				bone = 58271, x = -0.01, y = 0.0,  z = -0.11, xRot = -265.0,  yRot = 65.0, zRot = 0.0, category = 'melee', 		model = 'w_me_bat'},
	...
	{name = 'WEAPON_PISTOL', 			bone = 24818, x = -0.21, y = -0.12, z = 0.0, xRot = -180.0, yRot = 135.0, zRot = 10.0, category = 'handguns', 	model = 'w_pi_pistol'},
