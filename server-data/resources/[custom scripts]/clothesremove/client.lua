...
RegisterCommand('baju',function()
	TriggerEvent('smerfikubrania:koszulka')end,false)

RegisterCommand('celana', function()
	TriggerEvent('smerfikubrania:spodnie')end, false)

RegisterCommand('sepatu', function()
	TriggerEvent('smerfikubrania:buty')end, false)

RegisterCommand('pakaian', function()
	ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin)
	TriggerEvent('skinchanger:loadSkin', skin)end)
end,false)