...
RegisterCommand('modip',function()
...
Citizen.CreateThread(function()
	while true do
		...
		if IsPedInAnyVehicle(playerPed, false) then
			...
			if (PlayerData.job and PlayerData.job.name == 'mechanic' and PlayerData.job.grade_name ~= 'recrue') or not Config.IsMechanicJobOnly then
