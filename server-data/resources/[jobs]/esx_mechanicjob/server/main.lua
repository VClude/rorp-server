...
ESX.RegisterUsableItem('ban', function(source)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(source)
	TriggerClientEvent('esx_mechanicjob:gantiban',_source)	
end)

RegisterServerEvent('esx_mechanicjob:removeBan')
AddEventHandler('esx_mechanicjob:removeBan', function()
	local xPlayer = ESX.GetPlayerFromId(source)
	xPlayer.removeInventoryItem('ban',1)
end)
