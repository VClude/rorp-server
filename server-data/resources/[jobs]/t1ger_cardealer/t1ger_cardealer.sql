...
ADD `date` varchar(255) DEFAULT NULL AFTER `stored`,
ADD  `paidprice` int(11) NOT NULL DEFAULT '0' AFTER `date`,
ADD `finance` INT(32) NOT NULL DEFAULT '0' AFTER `paidprice`,
ADD `repaytime` INT(32) NOT NULL DEFAULT '0' AFTER `finance`,
ADD `model` varchar(60) NOT NULL AFTER `repaytime`;
