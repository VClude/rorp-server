...
Config.ReceiveBankMoney = false			-- Set this to false, in order to receive money in hand when selling a vehicle to PDM
...
Config.UseCashMoney = false										-- Set to false to use bank money, when depositing/withdrawing money from dealer society account
