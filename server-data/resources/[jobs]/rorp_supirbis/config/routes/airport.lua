    ...
    Lines = {
        {
            ...
            Stops = {
                ...
                {x = 251.56, y = -574.26, z = 42.96, name = 'stop_rumah_sakit2', unloadType = UnloadType.All},
                {x = 253.01,  y = -1502.8, z = 28.9,  name = 'stop_driving_school2', unloadType = UnloadType.Some},
                {x = -1034.18,  y = -2729.91, z = 20.08,  name = 'stop_crastenburg', unloadType = UnloadType.Some},
            }
        }
    }
}
