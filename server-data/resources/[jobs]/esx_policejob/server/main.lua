...
ESX.RegisterServerCallback("esx_policejob:getWeaponState", function(source, cb)
...
RegisterServerEvent("esx_policejob:weaponTakenOut")
AddEventHandler("esx_policejob:weaponTakenOut", function(weapon,giveAmmo)
    local xPlayer = ESX.GetPlayerFromId(source)
    local id = ESX.GetPlayerFromId(source).getIdentifier()
...
RegisterServerEvent("esx_policejob:weaponInStock")
AddEventHandler("esx_policejob:weaponInStock", function(weapon,ammo,giveAmmo)
    local xPlayer = ESX.GetPlayerFromId(source)
    local id = ESX.GetPlayerFromId(source).getIdentifier()
		...
		local embed = {
            {
                ...
                ["fields"] = {
                    ...
                    {
                        ["name"] = "**KETERANGAN**",
                        ["value"] = "Telah Mengembalikan Senjata **[ ".. ESX.GetWeaponLabel(weapon) .." ]** ke Police Armory Pada Tanggal **[ "..DATE.." ]**",
                    }
                },
                ["footer"] = {
                    ["text"] = "Kalian tidak akan luput dari pantauan ku"
...
RegisterServerEvent("esx_policejob:restockWeapons")
AddEventHandler("esx_policejob:restockWeapons", function(id)
...
ESX.RegisterServerCallback("esx_policejob:checkPoliceOnline", function(source, cb)
