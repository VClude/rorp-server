...
Config.CustomPeds = {
	...
	boss = {
		-- {label = 'Owner', maleModel = 'ig_trafficwarden', femaleModel = 'ig_trafficwarden'},
		-- {label = 'Administrator', maleModel = 's_m_y_dockwork_01', femaleModel = 's_f_y_dockwork_01'},
	}
}
...
Config.PoliceVehicles = {
	{ model = 'police3', label = 'Dodge Charger - Marked', price = 0 },
	{ model = 'fiat600', label = 'Police Vans - Marked', price = 0 },
	{ model = 'policeb', label = 'Police Bike - Marked', price = 0 },
	{ model = 'riot', label = 'Riot Car - Marked', price = 0 },
	{ model = 'fbi2', label = 'FBI Car - Marked', price = 0 }	
}
