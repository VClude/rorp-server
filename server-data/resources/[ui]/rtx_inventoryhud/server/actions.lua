ESX.RegisterServerCallback('rtx_inventoryhud:UseItemFromSlot', function(source, cb, slot)
...
ESX.RegisterServerCallback('rtx_inventoryhud:GetItemsInSlotsDisplay', function(source, cb)
    local player = ESX.GetPlayerFromId(source)
    InvType['player'].getInventory(player.identifier, function(inventory)
        local slotItems = {}
        for i = 1, 5, 1 do
