...
ESX.RegisterServerCallback('rtx_inventoryhud:getPlayerInventory', function(source, cb)
...
function ensurePlayerInventory(player)
    ...
    loadInventory(player.identifier, 'player', function()
        applyToInventory(player.identifier, 'player', function(inventory)
            ...
            TriggerClientEvent('rtx_inventoryhud:refreshInventory', player.source)
        end)
    end)
end

RegisterServerEvent('rtx_inventoryhud:notifyImpendingRemoval')
AddEventHandler('rtx_inventoryhud:notifyImpendingRemoval', function(item, count, playerSource)
...
RegisterServerEvent('rtx_inventoryhud:notifyImpendingAddition')
AddEventHandler('rtx_inventoryhud:notifyImpendingAddition', function(item, count, playerSource)
    local _source = playerSource or source
...
AddEventHandler('esx:onRemoveInventoryItem', function(source, item, count)
    ...
    TriggerClientEvent('rtx_inventoryhud:showItemUse', source, {
