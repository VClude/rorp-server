...
AddEventHandler("esx_atmRobbery:success",function()
	...
	if Config.EnableDirtyCash then
		...
		TriggerClientEvent("esx:showNotification",source,"Kamu mendapatkan ~b~Uang Kotor ~g~$"..reward )
	else
		xPlayer.addMoney(reward)
		TriggerClientEvent("esx:showNotification",source,"Kamu mendapatkan ~b~Cash ~g~$"..reward)
	end
end)
