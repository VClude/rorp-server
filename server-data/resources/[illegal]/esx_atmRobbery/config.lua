...
Config.DispatchMessage = "^3 Perampokan ^0 ATM di Jalan ^5%s^0"

-- Reward Settings:
Config.EnableDirtyCash = true			-- Set between true(receive dirty cash) or false(receive normal cash)		
Config.MinReward = 200					-- Set minimum payout
Config.MaxReward = 500					-- Set maximum payout

-- Other Settings:
Config.RobCooldown = 30					-- (minutes)
Config.Distance = 1.0 					-- Distance for drawTEXT to show
