...
Config.AmbulanceVehicles = {
	{ model = 'Ambulance', label = 'Dodge Charger - Marked', price = 0 },
	{ model = 'fiat600', label = 'Ambulance Vans - Marked', price = 0 },
	{ model = 'Ambulance', label = 'Ambulance Bike - Marked', price = 0 },
