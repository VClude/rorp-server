...
-- Display the lists of impound vehicles
...
-- End Display the lists of impound vehicles
...
-- Function to enter a vehicle in the pound
...
-- End function which allows to enter a vehicle in the pound
...
--Function for mechanical vehicle spawn
...
--End of function for mechanical vehicle spawn
